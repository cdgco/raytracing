...
class Camera {
public:
	Camera(Dims &dims, Vector3D m_look_from, Vector3D m_look_at = Vector3D(0, 0, 0), Vector3D m_v_up = Vector3D(0, 1, 0), double dAperture = 0.1, double dFocusDist = 10.0, double dVFOV = 20) {
